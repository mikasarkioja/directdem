...
export default function StatementPage() {
  ...
  const mockComments = [
    { text: "Talousarvion tasapainottaminen on välttämätöntä, mutta on varmistettava, ettei leikkaukset kohdistu heikoimmassa asemassa oleviin.", sentiment: "jaa" },
    { text: "Esitys on liian yksipuolinen. Tarvitsisimme laajempaa vaikutusarviointia ennen päätöksentekoa.", sentiment: "ei" },
    { text: "Tekninen toteutus näyttää hyvältä, mutta aikataulu on epärealistinen.", sentiment: "tyhjaa" }
  ];

  return (
    <div className="flex h-screen bg-[#F1F1F1] text-slate-900 overflow-hidden font-serif">
      <Sidebar activeView="bills" setActiveView={() => {}} user={null} />
      ...
      <main className="flex-1 overflow-y-auto relative custom-scrollbar p-4 md:p-12">
        ...
        {/* Paper Document */}
        <div className="max-w-4xl mx-auto bg-[#FCFCF9] shadow-[0_0_50px_rgba(0,0,0,0.1)] border border-slate-200 min-h-[140vh] p-12 md:p-20 relative overflow-hidden">
          ...
          {/* Summary Section */}
          <div className="py-12 space-y-6 leading-relaxed text-lg text-slate-800">
            <h2 className="text-xl font-black uppercase tracking-tight border-l-4 border-rose-900 pl-4 font-sans">1. Tiivistelmä kansan tahdosta</h2>
            <p>
              Kansan Varjoeduskunta on perehtynyt hallituksen esitykseen ja muodostanut siitä yhteisen kannan. 
              Analyysin perusteella kansalaisten suuri enemmistö painottaa esityksessä erityisesti asiantuntijatiedon merkitystä 
              sekä pitkän aikavälin kestävyyttä.
            </p>
            <p>
              Vaikka esityksen peruslinjat saavat tukea, on Varjoeduskunnan sisällä havaittavissa huolta esityksen yksityiskohdista, 
              jotka saattavat vaikuttaa epätasa-arvoisesti eri väestöryhmiin.
            </p>
          </div>

          {/* Data Visualization */}
          <div className="py-12 space-y-8 bg-slate-50/50 -mx-12 px-12 border-y border-slate-100">
            <h2 className="text-xl font-black uppercase tracking-tight border-l-4 border-rose-900 pl-4 font-sans">2. Äänten jakautuminen</h2>
          ...
          <div className="py-12 space-y-8">
            <h2 className="text-xl font-black uppercase tracking-tight border-l-4 border-rose-900 pl-4 font-sans">3. Asiantuntijalausunnot ja huomiot</h2>
          ...
          <div className="mt-20 pt-12 border-t border-slate-200 flex flex-col items-center text-center space-y-6">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 font-sans">
              ...
              <p className="text-lg font-black text-slate-900">12 450 VARJOKANSANEDUSTAJAA</p>
            </div>
          </div>
        </div>

        {/* Action Button Section (Floating or Bottom) */}
        <div className="max-w-4xl mx-auto mt-12 mb-20 flex flex-col items-center">
          <AnimatePresence mode="wait">
            {!isSent ? (
              <motion.button
                ...
                onClick={handleSend}
                disabled={sending}
                className="w-full md:w-auto px-12 py-6 bg-rose-900 text-white rounded-3xl font-black uppercase tracking-[0.3em] text-sm shadow-2xl shadow-rose-900/20 hover:bg-rose-800 hover:scale-[1.02] transition-all disabled:opacity-50 flex items-center gap-4 group"
              >
              ...
              <motion.div
                ...
                className="bg-emerald-500 text-white p-8 rounded-[2.5rem] flex flex-col items-center gap-4 text-center shadow-2xl shadow-emerald-500/20"
              >

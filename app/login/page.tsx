            ...
            >
              <form onSubmit={handleSendOtp} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-3 bg-blue-600 text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-blue-500 transition-all"
                >
                  {loading ? (
              ...
              <div className="mt-8 pt-8 border-t border-white/5 text-center">
                <p className="text-slate-500 text-[10px] uppercase font-bold tracking-widest mb-4">
                  Tai kokeile heti ilman sähköpostia
                </p>
                <button
            ...
            >
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="123456"
                  className="w-full bg-slate-800 border border-slate-700 text-white rounded-2xl py-4 px-6 text-center text-2xl tracking-[0.5em] outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-emerald-600 text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-emerald-500 transition-all"
              >
                {loading ? (
                  <Loader2 className="animate-spin" size={20} />
                ) : (
              ...
              <button
                ...
                className="w-full text-center text-[10px] text-slate-500 hover:text-white uppercase font-bold tracking-widest"
              >
                Takaisin
              </button>
            </motion.form>
            ...
            >
              <div className="text-center mb-4">
                ...
                <p className="text-slate-500 text-[10px] mt-1">
                  Pääset testaamaan kaikkia ominaisuuksia heti.
                </p>
              </div>
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-slate-500 ml-1">

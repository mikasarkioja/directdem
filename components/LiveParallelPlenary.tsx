...
export default function LiveParallelPlenary() {
  ...
  return (
    ...
    >
      <div className="bg-slate-900 border border-purple-500/30 rounded-[2.5rem] p-8 shadow-[0_0_50px_rgba(168,85,247,0.2)] backdrop-blur-2xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              <div className="w-16 h-16 rounded-2xl bg-rose-500/20 flex items-center justify-center border border-rose-500/30">
                <Radio size={32} className="text-rose-500 animate-pulse" />
              </div>
              <div className="absolute -top-2 -right-2 px-2 py-0.5 bg-rose-500 text-white text-[8px] font-black uppercase rounded-full">LIVE</div>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] font-black uppercase text-rose-500 tracking-widest">{sessionInfo.title}</p>
              <h4 className="text-xl font-black uppercase text-white tracking-tighter">{sessionInfo.currentItem}</h4>
          ...
          {/* Action Button */}
          <button className="flex items-center gap-3 bg-purple-600 hover:bg-purple-500 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs transition-all shadow-xl shadow-purple-600/20 active:scale-95 group">

...
export async function fetchLatestHelsinkiIssues(limit: number = 20): Promise<HelsinkiIssue[]> {
  ...
  return [
    ...
    { id: "HEL-2026-014", subject: "Hietaniemen uimarannan palvelut", subject: "Uusi ravintolarakennus ja pukutilojen uusiminen.", summary: "Rantapuiston viihtyisyyden lisääminen.", proposer: "Liikuntalautakunta", last_modified: "2025-12-27", issue_id: "HEL-14", category: "Vapaa-aika" },
